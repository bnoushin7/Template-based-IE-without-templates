...
def decompose_SP(sp_dict):
    ...
    print("type sp_dict {}".format(type(sp_dict)))

    for key in sp_dict.keys(): # if there is more than one, it writes more than one!
...
for NER in NER_Vectors_Index.keys():
    print("############################")
    #print(type(NER_Vectors_Index[NER]))
    #print(NER_Vectors_Index[NER])
    print(SP_Vectors[[0, 2, 5], :])
    print("############################")
